 ...
 * @author SophiaNachin
 */
public class BureauExamenListeEtudiants extends javax.swing.JFrame {

    /**
     * Creates new form B_ListeUE
     */
    public BureauExamenListeEtudiants() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BureauExamenListeEtudiants.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BureauExamenListeEtudiants().setVisible(true);
            }
        });
    }
